...
Você já sabe, mas não custa lembrar: Um envelope possui um ou mais documentos. As evidências relacionam-se diretament aos documentos e não aos envelopes.
:::
...
Atualmente não disponibilizamos nenhum endpoint para consultar o status do documento. Caso o documento não esteja em um status considerado "final", retornaremos um erro HTTP 500.
