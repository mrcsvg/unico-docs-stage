...
| --------- | ------------------ |
| Recursos adicionais do Unico Check para a captura com Smartlive com interação | [Download](https://cdn.unico.io/sdk/check/facetec/browser-v9.4.14/resources.zip)  |
...
Para instalar nosso SDK em seu projeto através do [npm](https://www.npmjs.com/package/unico-webframe), basta executar o comando abaixo: 
